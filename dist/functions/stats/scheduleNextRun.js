...
exports.default = new forgescript_1.NativeFunction({
    ...
    async execute(ctx) {
        if (!ctx.client.remainingTimes || !ctx.client.lastTick)
        ...
        if (remaining === undefined || lastTick === undefined)
            return this.customError("Invalid schedule data.");
        const elapsed = Date.now() - lastTick;
        const msLeft = remaining - elapsed;
        return this.success(msLeft > 0 ? msLeft : 0);
    }
});
//# sourceMappingURL=scheduleNextRun.js.map